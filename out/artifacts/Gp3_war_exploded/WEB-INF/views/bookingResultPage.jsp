...
<%--    <p>Number of Guests: <span id="num-guests"></span></p>--%>
<%--    <p>Special Requests: <span id="special-requests"></span></p>--%>
    <ul>
...
<%--    <p><span id="your-name"></span><br><span id="your-title"></span><br><br><span id="contact-info"></span></p>--%>
</div>
<script>
...
<%--<script>--%>
<%--&lt;%&ndash;    &lt;%&ndash;%>--%>
<%--&lt;%&ndash;        // Retrieving values using JSP scriptlets&ndash;%&gt;--%>
<%--&lt;%&ndash;        String tablename = (String) session.getAttribute("tablename");&ndash;%&gt;--%>
<%--&lt;%&ndash;        String date = (String) session.getAttribute("date");&ndash;%&gt;--%>
<%--&lt;%&ndash;        String time = (String) session.getAttribute("time");&ndash;%&gt;--%>
<%--&lt;%&ndash;        String bname = (String) session.getAttribute("bname");&ndash;%&gt;--%>
<%--&lt;%&ndash;        String phone = (String) session.getAttribute("phone");&ndash;%&gt;--%>
<%--&lt;%&ndash;        String nog = (String) session.getAttribute("nog");&ndash;%&gt;--%>
<%--&lt;%&ndash;        String sr = (String) session.getAttribute("sr");&ndash;%&gt;--%>
<%--&lt;%&ndash;    %>&ndash;%&gt;--%>
<%--    document.addEventListener("DOMContentLoaded", function () {--%>
<%--        document.getElementById("guest-name").textContent = "${sessionScope.bname}";--%>
<%--        document.getElementById("restaurant-name").textContent = "Gourmet Delights";--%>
<%--        document.getElementById("reservation-date").textContent = "${sessionScope.date}";--%>
<%--        document.getElementById("reservation-time").textContent = "${sessionScope.time}";--%>
<%--        document.getElementById("num-guests").textContent = "${sessionScope.nog}";--%>
<%--        document.getElementById("special-requests").textContent = "Vegetarian options";--%>
<%--        document.getElementById("your-name").textContent = "Jane Smith";--%>
<%--        document.getElementById("your-title").textContent = "Restaurant Manager";--%>
<%--        document.getElementById("contact-info").textContent = "Email: jane@example.com | Phone: (123) 456-7890";--%>
<%--    });--%>
<%--</script>--%>
</body>
</html>
